...
public class Character : MonoBehaviour 
{
	...
	/* 
	public class move {
		public string ID { get; set; }                 // name of the move
		...
		public float bonusScaling { get; set; }        // bonus damage scaling
		public int starterRating { get; set; }         // hitstun proration
		...
		public ArrayList hitbox { get; set; }          // detection box for HITTING OPPONENT (ID, delay, x offset, y offset, x size, y size, duration)
